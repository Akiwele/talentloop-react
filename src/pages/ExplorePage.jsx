...
const ExplorePage = () => {
  ...
  // Sample data for teachers/learners
   const users = [
    ...
    {
      id: 13,
      profilePicture: 'https://images.unsplash.com/photo-1525134479668-1bee5c7c6845?w=150&h=150&fit=crop&crop=face',
      username: 'jen_yoga',
      name: 'Jennifer Adams',
    ...
    {
      id: 20,
      profilePicture: 'https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?w=150&h=150&fit=crop&crop=face',
      username: 'tyler_3d',
      name: 'Tyler Green',
  ...
  const currentUser = {
    profilePicture: 'https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=50&h=50&fit=crop&crop=face',
